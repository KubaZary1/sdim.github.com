  ...
  return (
    <>
      <div className="container">
        ...
        Mordechaj Anielewicz urodził się w Wyszykowie w 1919 roku. Jego rodzice
        to Abram i Cyryla z domu Zandram. Kiedy Mordechaj miał kilka lat, cała
        rodzina Anielewiczów przeprowadziła się z Wyszkowa do Warszawy. Bohater
        ...
        miasta, a pod koniec 1939 wyjechał na kilka tygodni do Wilna. Po
        powrocie do Warszawy kontynuował swoją działalność w Komendzie Naczelnej
        Ha-Szomer Ha-Cair. Włączył się także do redagowania pisma Neged Hazerem
        i był instruktorem w kibucu przy ul. Nalewki 23. Przyjaźnił się z
        Emanuelem Ringelblumem .<div className="nowyRozdzial">4. Powstanie</div>
        W marcu 1942, Mordechaj Anielewicz rozpoczął współorganizowanie Bloku
        ...
        organizował grupy samoobrony Żydów w Będzinie i Sosnowcu. W jesieni 1942
        powrócił do Warszawy po zakończeniu wielkiej akcji deportacyjnej do
        Treblinki. Od października 1942, Anielewicz był komendantem Żydowskiej
        Organizacji Bojowej. Był jednym ze współorganizatorów udanego zamachu na
        zastępcę komendanta Żydowskiej Służby Porządkowej w październiku 1942. W
        styczniu 1943, Mordechaj Anielewicz kierował pierwszą zbrojną samoobroną
        w getcie warszawskim, która doprowadziła do przerwania drugiej
        niemieckiej akcji deportacyjnej do Treblinki. W walkach zginęło wielu
        żydowskich bojowców, ale udało się uratować kilkudziesięciu Żydów
        prowadzonych na Umschlagplatz. Anielewicz stał się znanym i szanowanym
        dowódcą po styczniowych walkach. Był zwolennikiem porozumienia z
        Żydowskim Związkiem Wojskowym. W kwietniu 1943, Mordechaj Anielewicz
        stanął na czele powstania w getcie warszawskim, które trwało do maja
        1943. Anielewicz zginął wraz z członkami dowództwa ŻOB 8 maja 1943 w
        otoczonym przez Niemców bunkrze przy ul. Miłej 18. Okoliczności jego
